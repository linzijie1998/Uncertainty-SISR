...
def main():
    parser = argparse.ArgumentParser(description="valid swinir edl")
    ...
    parser.add_argument("--model_path", default=r"./checkpoints/swinir/edl/epoch91_DIV2K_s80w8_x3.pth")
    ...
    for ds_name in ['Set5', 'Set14', 'BSD100', 'Urban100', 'DIV2K']:
        ...
        for i in range(len(lrs)):
            ...
            gamma, mu, alpha, beta = torch.split(sr_tensor, 3, dim=1)
    ...
    result_file = f"./output/swinir/metric_swinir_edl_x{str(args.upscale)}.csv"
